function Hero({header, text, img}) {
  return (
    <div className="flex px-5 min-[550px]:px-10 pt-[150px] pb-15">
      <div className="max-w-[1200px] mx-auto grid grid-cols-1 grid-rows-2 min-[1100px]:grid-cols-2 gap-6">
        ...
        <div className="max-[1100px]:h-[500px] rounded-[12px] overflow-hidden">
