...
function Hero() {
  ...
  const {id} = useParams()
  const service = services(t)
  const data = service.find(i => i.id == id.split("-")[0])
  return (
    <div className={`flex px-5 min-[550px]:px-10 py-[10px] items-center hero-blog-${id.split("-")[0]} h-[100vh]`}>
