...
function AboutSection() {
  return (
    <div className="py-20 bg-secondary">
      <div className="max-w-[1200px] mx-auto bg-[#FFFFFF0D] flex justify-between gap-[237px] mb-10">
        ...
        <div className="max-w-[792px]">
          ...
          <p className="font-[500] text-[18px] text-secondary leading-[150%]">
      ...
      <div className="max-w-[1200px] mx-auto bg-[#FFFFFF0D] flex justify-between gap-[142px]">
        ...
        <div className="rounded-[12px] max-w-[792px] w-full">
