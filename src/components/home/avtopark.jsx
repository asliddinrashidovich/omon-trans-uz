...
function AvtoParkSection() {
  return (
    <div className="py-20 bg-secondary">
      ...
      <div className="max-w-[1200px] mx-auto grid grid-cols-2 gap-[24px]">
        <div className="p-6 rounded-[12px] bg-white">
          ...
          <div className="flex justify-between items-center mb-8">
            ...
            <div className="py-[6px] max-w-[240px] w-full">
          ...
          <div className="flex gap-2">
            <Button icon={false}>Buyurtma berish</Button>
            <button
              className={
                "bg-transparent  py-4 px-8 rounded-[60px] bg-secondary cursor-pointer text-third font-[600] text-[16px]"
              }
            >
              Batafsil ma’lumot
            </button>
